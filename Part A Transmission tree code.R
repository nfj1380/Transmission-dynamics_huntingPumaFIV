...
#-----------------------------------------------#
#####Part A: Transmission tree code and drop tip analysis#####
...
saveRDS(tre_treatment, 'tre_treatment')
#-----------------------------------------------#
#####Turn into a graph#####
#-----------------------------------------------#
...
saveRDS(malesHphly, 'malesHphly_treatment')
malesHphly  
...
#make a data frame of vertex names and attributes
...
#within host
NeG <- sapply(ttree_stable,function(x) x$neg)

summary(NeG)

#Other diagnotic plots

a <- getIncidentCases(ttree_stable,show.plot = T, burnin = 0.1)
b <- getSamplingTimeDist(ttree_stable,show.plot = T)
c <- getGenerationTimeDist(ttree_stable,show.plot = T)

cons$nam
d <- getInfectionTimeDist(ttree_stable,k='x1952_2004-05-28',show.plot = T)
as.data.frame(d)
mean(d)

a1 <- getInfectionTimeDist(ttree_stable,k='X1077_FR_2010-28-01',show.plot = T) #F52
b1 <- getInfectionTimeDist(ttree_stable,k='X1552_FR_2011-24-03',show.plot = T) #AM83
c1 <- getInfectionTimeDist(ttree_stable,k='X298R1_FR_2009-18-03',show.plot = T) #AF19

d1 <- getInfectionTimeDist(ttree_stable,k='X1647_WS_2012-23-01',show.plot = T) #M161 born WS22 April 2011
e1 <- getInfectionTimeDist(ttree_stable,k='X1674_FR_2013-04-01',show.plot = T) #AM98 born speing 2012

f1 <- getInfectionTimeDist(ttree_stable,k='X1064_FR_2010-14-01',show.plot = T) #AF54
g1 <- getInfectionTimeDist(ttree_stable,k='X299_FR_2009-06-03',show.plot = T) #AM20
...
trans_tree_extract <- function(treeList, dateLastSample = 2013.211 ){ #make sure the dates are correct here
